...
export default function Comments(){
    ...
    return(
        <div>
            <div>
            <Avatar sx={{ width: 30, height: 30, mt: 4, ml: 1, mb: 3.5, display: 'inline-block'}} aria-label="recipe"  src={Song}/>
            ...
            <div>  
            <Avatar sx={{ width: 30, height: 30, mt:2, ml: 1, mb: 1, display: 'inline-block'}} aria-label="recipe"  src={Hyo}/>
            <Box sx={{display: 'inline-block', ml: 1, maxWidth: '500px'}}>
            ...
            {/* <Avatar sx={{ width: 30, height: 30}} aria-label="recipe"  src={Hyo}/>  */}
        </div>
    );
}